...
'use strict';
goog.provide('Blockly.Msg.constants');
...
Blockly.Msg.ANIMATION_FIELD_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Animation.html#%1";  // untranslated
...
Blockly.Msg.ARDUINO_STRING_CHAR_AT = "character at position";  // untranslated
Blockly.Msg.ARDUINO_STRING_CHAR_AT_HELP_URL = "https://www.arduino.cc/reference/en/language/variables/data-types/string/functions/charat/";  // untranslated
Blockly.Msg.ARDUINO_STRING_CHAR_AT_STRING = "from string";  // untranslated
Blockly.Msg.ARDUINO_STRING_CHAR_AT_TOOLTIP = "Finds the character in the String at the given position.";  // untranslated
Blockly.Msg.ARDUINO_STRING_COMPARE_TO = "come before";  // untranslated
Blockly.Msg.ARDUINO_STRING_COMPARE_TO_HELP_URL = "https://www.arduino.cc/reference/en/language/variables/data-types/string/functions/compareto/";  // untranslated
Blockly.Msg.ARDUINO_STRING_COMPARE_TO_TOOLTIP = "Compares two Strings. Returns a negative number if LHS comes before RHS. Returns 0 if they are equal. Returns a positive number if LHS comes after RHS.";  // untranslated
Blockly.Msg.ARDUINO_STRING_CONCAT = "concatenate";  // untranslated
Blockly.Msg.ARDUINO_STRING_CONCAT_HELP_URL = "https://www.arduino.cc/reference/en/language/variables/data-types/string/functions/concat/";  // untranslated
Blockly.Msg.ARDUINO_STRING_CONCAT_TOOLTIP = "Appends the parameter to the String.";  // untranslated
Blockly.Msg.ARDUINO_STRING_CREATE = "create String from";  // untranslated
Blockly.Msg.ARDUINO_STRING_CREATE_BASE = "in base";  // untranslated
Blockly.Msg.ARDUINO_STRING_CREATE_BASE_HELP_URL = "https://www.arduino.cc/reference/en/language/variables/data-types/stringobject/";  // untranslated
Blockly.Msg.ARDUINO_STRING_CREATE_BASE_INPUT = "create String from";  // untranslated
Blockly.Msg.ARDUINO_STRING_CREATE_BASE_TOOLTIP = "Create a String from the given contents with the given base.";  // untranslated
Blockly.Msg.ARDUINO_STRING_CREATE_HELP_URL = "https://www.arduino.cc/reference/en/language/variables/data-types/stringobject/";  // untranslated
Blockly.Msg.ARDUINO_STRING_CREATE_TOOLTIP = "Create a String from the given contents.";  // untranslated
Blockly.Msg.ARDUINO_STRING_ENDS_WITH = "end with";  // untranslated
Blockly.Msg.ARDUINO_STRING_ENDS_WITH_HELP_URL = "https://www.arduino.cc/reference/en/language/variables/data-types/string/functions/endswith/";  // untranslated
Blockly.Msg.ARDUINO_STRING_ENDS_WITH_TOOLTIP = "Tests whether or not a String ends with the characters of another String.";  // untranslated
Blockly.Msg.ARDUINO_STRING_EQUALS = "the same as";  // untranslated
Blockly.Msg.ARDUINO_STRING_EQUALS_CASE = "not ignoring case?";  // untranslated
Blockly.Msg.ARDUINO_STRING_EQUALS_HELP_URL = "https://www.arduino.cc/reference/en/language/variables/data-types/string/functions/equals/";  // untranslated
Blockly.Msg.ARDUINO_STRING_EQUALS_IGNORE = "the same as";  // untranslated
Blockly.Msg.ARDUINO_STRING_EQUALS_IGNORE_CASE = "ignoring case?";  // untranslated
Blockly.Msg.ARDUINO_STRING_EQUALS_IGNORE_HELP_URL = "https://www.arduino.cc/reference/en/language/variables/data-types/string/functions/equalsignorecase/";  // untranslated
Blockly.Msg.ARDUINO_STRING_EQUALS_IGNORE_TOOLTIP = "Compares two Strings for equality, regardless of case.";  // untranslated
Blockly.Msg.ARDUINO_STRING_EQUALS_TOOLTIP = "Compares two Strings for equality.";  // untranslated
Blockly.Msg.ARDUINO_STRING_INDEX_OF = "index of";  // untranslated
Blockly.Msg.ARDUINO_STRING_INDEX_OF_HELP_URL = "https://www.arduino.cc/reference/en/language/variables/data-types/string/functions/indexof/";  // untranslated
Blockly.Msg.ARDUINO_STRING_INDEX_OF_LOCATION = "starting at position";  // untranslated
Blockly.Msg.ARDUINO_STRING_INDEX_OF_TOOLTIP = "Locates a character or String within another String.";  // untranslated
Blockly.Msg.ARDUINO_STRING_LENGTH = "length of";  // untranslated
Blockly.Msg.ARDUINO_STRING_LENGTH_HELP_URL = "https://www.arduino.cc/reference/en/language/variables/data-types/string/functions/length/";  // untranslated
Blockly.Msg.ARDUINO_STRING_LENGTH_TOOLTIP = "Returns the length of the String, in characters.";  // untranslated
Blockly.Msg.ARDUINO_STRING_REMOVE = "remove characters from";  // untranslated
Blockly.Msg.ARDUINO_STRING_REMOVE_HELP_URL = "https://www.arduino.cc/reference/en/language/variables/data-types/string/functions/remove/";  // untranslated
Blockly.Msg.ARDUINO_STRING_REMOVE_TOOLTIP = "Modify in place a String removing chars between the given indices.";  // untranslated
Blockly.Msg.ARDUINO_STRING_REPLACE = "replace";  // untranslated
Blockly.Msg.ARDUINO_STRING_REPLACE_HELP_URL = "https://www.arduino.cc/reference/en/language/variables/data-types/string/functions/replace/";  // untranslated
Blockly.Msg.ARDUINO_STRING_REPLACE_TOOLTIP = "Replaces all instance of the given character/substring with another character/substring.";  // untranslated
Blockly.Msg.ARDUINO_STRING_STARTS_WITH = "start with";  // untranslated
Blockly.Msg.ARDUINO_STRING_STARTS_WITH_HELP_URL = "https://www.arduino.cc/reference/en/language/variables/data-types/string/functions/startswith/";  // untranslated
Blockly.Msg.ARDUINO_STRING_STARTS_WITH_TOOLTIP = "Tests whether or not a String starts with the characters of another String.";  // untranslated
Blockly.Msg.ARDUINO_STRING_SUBSTRING = "substring of";  // untranslated
Blockly.Msg.ARDUINO_STRING_SUBSTRING_HELP_URL = "https://www.arduino.cc/reference/en/language/variables/data-types/string/functions/substring/";  // untranslated
Blockly.Msg.ARDUINO_STRING_SUBSTRING_TOOLTIP = "Get a substring of a String between the given indices.";  // untranslated
Blockly.Msg.ARDUINO_STRING_TO_FLOAT = "to float";  // untranslated
Blockly.Msg.ARDUINO_STRING_TO_FLOAT_HELP_URL = "https://www.arduino.cc/reference/en/language/variables/data-types/string/functions/tofloat/";  // untranslated
Blockly.Msg.ARDUINO_STRING_TO_FLOAT_TOOLTIP = "Converts a valid String to an float. The input String should start with an float number.";  // untranslated
Blockly.Msg.ARDUINO_STRING_TO_INT = "to int";  // untranslated
Blockly.Msg.ARDUINO_STRING_TO_INT_HELP_URL = "https://www.arduino.cc/reference/en/language/variables/data-types/string/functions/toint/";  // untranslated
Blockly.Msg.ARDUINO_STRING_TO_INT_TOOLTIP = "Converts a valid String to an integer. The input String should start with an integer number.";  // untranslated
Blockly.Msg.ARDUINO_STRING_TO_LOWER = "to lower-case";  // untranslated
Blockly.Msg.ARDUINO_STRING_TO_LOWER_HELP_URL = "https://www.arduino.cc/reference/en/language/variables/data-types/string/functions/tolowercase/";  // untranslated
Blockly.Msg.ARDUINO_STRING_TO_LOWER_TOOLTIP = "Get a lower-case version of a String.";  // untranslated
Blockly.Msg.ARDUINO_STRING_TO_UPPER = "to upper-case";  // untranslated
Blockly.Msg.ARDUINO_STRING_TO_UPPER_HELP_URL = "https://www.arduino.cc/reference/en/language/variables/data-types/string/functions/touppercase/";  // untranslated
Blockly.Msg.ARDUINO_STRING_TO_UPPER_TOOLTIP = "Get a upper-case version of a String.";  // untranslated
Blockly.Msg.ARDUINO_STRING_TRIM = "trim";  // untranslated
Blockly.Msg.ARDUINO_STRING_TRIM_HELP_URL = "https://www.arduino.cc/reference/en/language/variables/data-types/string/functions/touppercase/";  // untranslated
Blockly.Msg.ARDUINO_STRING_TRIM_TOOLTIP = "Get a version of the String with any leading and trailing whitespace removed.";  // untranslated
...
Blockly.Msg.BETWEEN = "between";  // untranslated
...
Blockly.Msg.BODY_FIELD_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Physics.Arcade.Body.html#%1";  // untranslated
Blockly.Msg.BODY_SET_SIZE = "set body size for";  // untranslated
Blockly.Msg.BODY_SET_SIZE_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Physics.Arcade.Body.html#setSize";  // untranslated
Blockly.Msg.BODY_SET_SIZE_TOOLTIP = "Modify the physics Body to be any dimension.";  // untranslated
...
Blockly.Msg.CHAR_INPUT_HELP_URL = "https://www.tutorialspoint.com/c_standard_library/ctype_h.htm";  // untranslated
Blockly.Msg.CHAR_INPUT_TOOLTIP = "character input";  // untranslated
Blockly.Msg.CHAR_IS_ALNUM = "alphanumeric?";  // untranslated
Blockly.Msg.CHAR_IS_ALNUM_HELP_URL = "https://www.tutorialspoint.com/c_standard_library/c_function_isalnum.htm";  // untranslated
Blockly.Msg.CHAR_IS_ALNUM_TOOLTIP = "Returns non-zero value if c is a digit or a letter, else it returns 0.";  // untranslated
Blockly.Msg.CHAR_IS_ALPHA = "alphabetic?";  // untranslated
Blockly.Msg.CHAR_IS_ALPHA_HELP_URL = "https://www.tutorialspoint.com/c_standard_library/c_function_isalpha.htm";  // untranslated
Blockly.Msg.CHAR_IS_ALPHA_TOOLTIP = "Returns non-zero value if c is an alphabet, else it returns 0.";  // untranslated
Blockly.Msg.CHAR_IS_CNTRL = "a control character?";  // untranslated
Blockly.Msg.CHAR_IS_CNTRL_HELP_URL = "https://www.tutorialspoint.com/c_standard_library/c_function_iscntrl.htm";  // untranslated
Blockly.Msg.CHAR_IS_CNTRL_TOOLTIP = "Returns non-zero value if c is a control character, else it returns 0.";  // untranslated
Blockly.Msg.CHAR_IS_DIGIT = "a digit?";  // untranslated
Blockly.Msg.CHAR_IS_DIGIT_HELP_URL = "https://www.tutorialspoint.com/c_standard_library/c_function_isdigit.htm";  // untranslated
Blockly.Msg.CHAR_IS_DIGIT_TOOLTIP = "Returns non-zero value if c is a digit, else it returns 0.";  // untranslated
Blockly.Msg.CHAR_IS_GRAPH = "have graphical representation?";  // untranslated
Blockly.Msg.CHAR_IS_GRAPH_HELP_URL = "https://www.tutorialspoint.com/c_standard_library/c_function_isgraph.htm";  // untranslated
Blockly.Msg.CHAR_IS_GRAPH_TOOLTIP = "Returns non-zero value if c has graphical representation, else it returns 0.";  // untranslated
Blockly.Msg.CHAR_IS_LOWER = "lower-case?";  // untranslated
Blockly.Msg.CHAR_IS_LOWER_HELP_URL = "https://www.tutorialspoint.com/c_standard_library/c_function_islower.htm";  // untranslated
Blockly.Msg.CHAR_IS_LOWER_TOOLTIP = "Returns non-zero value if c is a lowercase alphabetic letter, else it returns 0.";  // untranslated
Blockly.Msg.CHAR_IS_PRINT = "printable?";  // untranslated
Blockly.Msg.CHAR_IS_PRINT_HELP_URL = "https://www.tutorialspoint.com/c_standard_library/c_function_isprint.htm";  // untranslated
Blockly.Msg.CHAR_IS_PRINT_TOOLTIP = "Returns non-zero value if c is a printable character, else it returns 0.";  // untranslated
Blockly.Msg.CHAR_IS_PUNCT = "a punctuation character?";  // untranslated
Blockly.Msg.CHAR_IS_PUNCT_HELP_URL = "https://www.tutorialspoint.com/c_standard_library/c_function_ispunct.htm";  // untranslated
Blockly.Msg.CHAR_IS_PUNCT_TOOLTIP = "Returns non-zero value if c is a punctuation character, else it returns 0.";  // untranslated
Blockly.Msg.CHAR_IS_SPACE = "a space?";  // untranslated
Blockly.Msg.CHAR_IS_SPACE_HELP_URL = "https://www.tutorialspoint.com/c_standard_library/c_function_isspace.htm";  // untranslated
Blockly.Msg.CHAR_IS_SPACE_TOOLTIP = "Returns non-zero value if c is a white-space character, else it returns 0.";  // untranslated
Blockly.Msg.CHAR_IS_UPPER = "upper-case?";  // untranslated
Blockly.Msg.CHAR_IS_UPPER_HELP_URL = "https://www.tutorialspoint.com/c_standard_library/c_function_isupper.htm";  // untranslated
Blockly.Msg.CHAR_IS_UPPER_TOOLTIP = "Returns non-zero value if c is upper-case, else it returns 0.";  // untranslated
Blockly.Msg.CHAR_IS_XDIGIT = "a hexadecimal digit?";  // untranslated
Blockly.Msg.CHAR_IS_XDIGIT_HELP_URL = "https://www.tutorialspoint.com/c_standard_library/c_function_isxdigit.htm";  // untranslated
Blockly.Msg.CHAR_IS_XDIGIT_TOOLTIP = "Returns non-zero value if c is a hexadecimal digit, else it returns 0.";  // untranslated
Blockly.Msg.CHAR_TO_LOWER = "lower-case";  // untranslated
Blockly.Msg.CHAR_TO_LOWER_HELP_URL = "https://www.tutorialspoint.com/c_standard_library/c_function_tolower.htm";  // untranslated
Blockly.Msg.CHAR_TO_LOWER_TOOLTIP = "Returns the lower-case value of the given character.";  // untranslated
Blockly.Msg.CHAR_TO_UPPER = "upper-case";  // untranslated
Blockly.Msg.CHAR_TO_UPPER_HELP_URL = "https://www.tutorialspoint.com/c_standard_library/c_function_toupper.htm";  // untranslated
Blockly.Msg.CHAR_TO_UPPER_TOOLTIP = "Returns the upper-case value of the given character.";  // untranslated
...
Blockly.Msg.CIRCLE_FIELDS_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Circle.html#%1";  // untranslated
...
Blockly.Msg.COLLIDES = "collide?";  // untranslated
Blockly.Msg.COLLIDE_BOOLEAN = "and return result";  // untranslated
...
Blockly.Msg.CONVERT = "convert";  // untranslated
...
Blockly.Msg.CULL = "auto cull";  // untranslated
...
Blockly.Msg.DEBUG_BODY_RENDER = "render body for";  // untranslated
Blockly.Msg.DEBUG_BODY_RENDER_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Physics.Arcade.Body.html#render";  // untranslated
Blockly.Msg.DEBUG_BODY_RENDER_TOOLTIP = "Render Sprite Body.";  // untranslated
...
Blockly.Msg.DEVICE_BUTTON_FIELD_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.DeviceButton.html#%1";  // untranslated
...
Blockly.Msg.EXISTS = "exists";  // untranslated
...
Blockly.Msg.FILL = "fill";  // untranslated
...
Blockly.Msg.FOR_START_VALUE = "starting at";  // untranslated
...
Blockly.Msg.GAME_OBJECT_FIELD_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Sprite.html#%1";  // untranslated
...
Blockly.Msg.GET_ARRAY_FIELD = "get array field";  // untranslated
...
Blockly.Msg.GET_DEVICE_BUTTON_FIELD_VI_TOOLTIP = "Get the %1 field for the selected DeviceButton";  // untranslated
...
Blockly.Msg.GET_TIMER_BOOLEAN_MEMBER_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Timer.html";  // untranslated
Blockly.Msg.GET_TIMER_BOOLEAN_MEMBER_TITLE = "get";  // untranslated
Blockly.Msg.GET_TIMER_BOOLEAN_MEMBER_TOOLTIP = "Read boolean fields of game timer.";  // untranslated
Blockly.Msg.GET_TIMER_NUMERIC_MEMBER_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Timer.html";  // untranslated
Blockly.Msg.GET_TIMER_NUMERIC_MEMBER_TITLE = "get";  // untranslated
Blockly.Msg.GET_TIMER_NUMERIC_MEMBER_TOOLTIP = "Read numeric fields of game timer.";  // untranslated
...
Blockly.Msg.GET_WORLD = "game.world";  // untranslated
Blockly.Msg.GET_WORLD_HELP_URL = "";  // untranslated
...
Blockly.Msg.GET_WORLD_TOOLTIP = "";  // untranslated
Blockly.Msg.GID = "gid";  // untranslated
...
Blockly.Msg.IF_COLLIDING = "if colliding";  // untranslated
...
Blockly.Msg.INCREMENT = "increment by";  // untranslated
...
Blockly.Msg.INPUT_HANDLER_FIELD_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.InputHandler.html#%1";  // untranslated
...
Blockly.Msg.KEY_FIELD_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Key.html#%1";  // untranslated
...
Blockly.Msg.LAYER = "layer";  // untranslated
...
Blockly.Msg.LOGIC_OPERATION_AND_TOOLTIP = "Returns true if all inputs are true.";  // untranslated
Blockly.Msg.LOGIC_OPERATION_HELPURL = "https://github.com/google/blockly/wiki/Logic#logical-operations";  // untranslated
Blockly.Msg.LOGIC_OPERATION_OR = "or";  // untranslated
Blockly.Msg.LOGIC_OPERATION_OR_TOOLTIP = "Returns true if some inputs are true.";  // untranslated
...
Blockly.Msg.OFFSET_X = "offset x";  // untranslated
Blockly.Msg.OFFSET_Y = "offset y";  // untranslated
...
Blockly.Msg.OR = "or";  // untranslated
...
Blockly.Msg.PHASER_ADD_TILEMAP = "add tilemap";  // untranslated
Blockly.Msg.PHASER_ADD_TILEMAP_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.GameObjectFactory.html#tilemap";  // untranslated
Blockly.Msg.PHASER_ADD_TILEMAP_TOOLITP = "Creates a new Phaser.Tilemap object.";  // untranslated
Blockly.Msg.PHASER_ADD_TILSET_IMAGE = "add tileset image for";  // untranslated
Blockly.Msg.PHASER_ADD_TILSET_IMAGE_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#addTilesetImage";  // untranslated
Blockly.Msg.PHASER_ADD_TILSET_IMAGE_TOOLTIP = "Adds an image to the map to be used as a tileset.";  // untranslated
Blockly.Msg.PHASER_CREATE_TILEMAP_LAYER = "create layer number";  // untranslated
Blockly.Msg.PHASER_CREATE_TILEMAP_LAYER_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#createLayer";  // untranslated
Blockly.Msg.PHASER_CREATE_TILEMAP_LAYER_TOOLTIP = "Creates a new TilemapLayer object.";  // untranslated
...
Blockly.Msg.PHASER_LOAD_TILEMAP = "create tilemap";  // untranslated
Blockly.Msg.PHASER_LOAD_TILEMAP_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Loader.html#tilemap";  // untranslated
Blockly.Msg.PHASER_LOAD_TILEMAP_TOOLTIP = "Adds a Tile Map data file to the current load queue.";  // untranslated
...
Blockly.Msg.PHASER_TILEMAP_DIRECTIONS_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#_EAST";  // untranslated
Blockly.Msg.PHASER_TILEMAP_DIRECTIONS_TOOLTIP = "";  // untranslated
Blockly.Msg.PHASER_TILEMAP_FIELD_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#toc-3";  // untranslated
Blockly.Msg.PHASER_TILEMAP_GET_FIELD_TOOLTIP = "Get member fields for the given map.";  // untranslated
Blockly.Msg.PHASER_TILEMAP_GET_LAYER_FIELD = "get current layer for";  // untranslated
Blockly.Msg.PHASER_TILEMAP_GET_LAYER_FIELD_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#layer";  // untranslated
Blockly.Msg.PHASER_TILEMAP_GET_LAYER_FIELD_TOOLTIP = "The current layer object.";  // untranslated
Blockly.Msg.PHASER_TILEMAP_SET_FIELD_TOOLTIP = "Set member fields for the given map.";  // untranslated
Blockly.Msg.PHASER_TILEMAP_SET_LAYER_FIELD = "set current layer for";  // untranslated
Blockly.Msg.PHASER_TILEMAP_SET_LAYER_FIELD_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#layer";  // untranslated
Blockly.Msg.PHASER_TILEMAP_SET_LAYER_FIELD_TOOLTIP = "The current layer object.";  // untranslated
...
Blockly.Msg.PHYSICS_FIELD_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Physics.Arcade.html#%1";  // untranslated
...
Blockly.Msg.PROPERTIES = "properties";  // untranslated
Blockly.Msg.PUT = "put tile";  // untranslated
...
Blockly.Msg.RECALCULATE = "recalculate?";  // untranslated
...
Blockly.Msg.RECTANGLE_FIELDS_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Rectangle.html#%1";  // untranslated
...
Blockly.Msg.SET_ARRAY_FIELD = "set array field";  // untranslated
...
Blockly.Msg.SET_TIMER_BOOLEAN_MEMBER_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Timer.html";  // untranslated
Blockly.Msg.SET_TIMER_BOOLEAN_MEMBER_TITLE = "set";  // untranslated
Blockly.Msg.SET_TIMER_BOOLEAN_MEMBER_TO = "to";  // untranslated
Blockly.Msg.SET_TIMER_BOOLEAN_MEMBER_TOOLTIP = "Write to one of the game timer's boolean fields.";  // untranslated
Blockly.Msg.SET_TIMER_NUMERIC_MEMBER_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Timer.html";  // untranslated
Blockly.Msg.SET_TIMER_NUMERIC_MEMBER_TITLE = "set";  // untranslated
Blockly.Msg.SET_TIMER_NUMERIC_MEMBER_TO = "to";  // untranslated
Blockly.Msg.SET_TIMER_NUMERIC_MEMBER_TOOLTIP = "Write to one of the game timer's numeric fields.";  // untranslated
...
Blockly.Msg.SKIP = "skip";  // untranslated
...
Blockly.Msg.SPRITE_GET_TAG = "get tag of sprite";  // untranslated
Blockly.Msg.SPRITE_GET_TAG_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Sprite.html#key";  // untranslated
Blockly.Msg.SPRITE_GET_TAG_TOOLTIP = "The key of the image or texture used by this Game Object during rendering.";  // untranslated
...
Blockly.Msg.STEPPER_CREATE = "create stepper with";  // untranslated
Blockly.Msg.STEPPER_HELP_URL = "https://www.arduino.cc/en/Reference/StepperConstructor";  // untranslated
Blockly.Msg.STEPPER_SET_SPEED = "set speed of stepper to";  // untranslated
Blockly.Msg.STEPPER_SET_SPEED_HELP_URL = "https://www.arduino.cc/en/Reference/StepperSetSpeed";  // untranslated
Blockly.Msg.STEPPER_SET_SPEED_TOOLTIP = "Sets the motor speed in rotations per minute (RPMs).";  // untranslated
Blockly.Msg.STEPPER_STEPS = "turn stepper";  // untranslated
Blockly.Msg.STEPPER_STEPS_HELP_URL = "https://www.arduino.cc/en/Reference/StepperStep";  // untranslated
Blockly.Msg.STEPPER_STEPS_TOOLTIP = "Turns the motor a specific number of steps, at a speed determined by the most recent call to setSpeed().";  // untranslated
Blockly.Msg.STEPPER_TOOLTIP = "Creates a new instance of the Stepper class that represents a particular stepper motor attached to your Arduino board.";  // untranslated
...
Blockly.Msg.SWITCH_EDGE_TO_AMBIENT = "switch edge to ambient";  // untranslated
...
Blockly.Msg.TILEMAP_ADJUST_Y = "adjust y";  // untranslated
Blockly.Msg.TILEMAP_COPY = "copy tiles from";  // untranslated
Blockly.Msg.TILEMAP_COPY_BOUNDS = "with the bounds of";  // untranslated
Blockly.Msg.TILEMAP_COPY_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#toc-4";  // untranslated
Blockly.Msg.TILEMAP_COPY_LAYER = "on layer";  // untranslated
Blockly.Msg.TILEMAP_COPY_POSITION = "starting at position";  // untranslated
Blockly.Msg.TILEMAP_COPY_TOOLTIP = "Copies all of the tiles in the given rectangular block into the tilemap data buffer.";  // untranslated
Blockly.Msg.TILEMAP_CREATE = "reset tile map";  // untranslated
Blockly.Msg.TILEMAP_CREATE_BLANK_LAYER = "add blank layer to";  // untranslated
Blockly.Msg.TILEMAP_CREATE_BLANK_LAYER_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#createBlankLayer";  // untranslated
Blockly.Msg.TILEMAP_CREATE_BLANK_LAYER_TOOLTIP = "Creates a new and empty layer on this Tilemap.";  // untranslated
Blockly.Msg.TILEMAP_CREATE_FROM_OBJECTS = "add objects to";  // untranslated
Blockly.Msg.TILEMAP_CREATE_FROM_OBJECTS_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#createBlankLayer";  // untranslated
Blockly.Msg.TILEMAP_CREATE_FROM_OBJECTS_NAME = "from the group";  // untranslated
Blockly.Msg.TILEMAP_CREATE_FROM_OBJECTS_TOOLTIP = "Creates a Sprite for every object matching the gid argument.";  // untranslated
Blockly.Msg.TILEMAP_CREATE_FROM_TILES = "create objects from tiles in";  // untranslated
Blockly.Msg.TILEMAP_CREATE_FROM_TILES_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#createFromTiles";  // untranslated
Blockly.Msg.TILEMAP_CREATE_FROM_TILES_REPLACEMENT = "replacing with the tiles from position";  // untranslated
Blockly.Msg.TILEMAP_CREATE_FROM_TILES_TOOLTIP = "Creates a Sprite for every object matching the given tile indexes in the map data.";  // untranslated
Blockly.Msg.TILEMAP_CREATE_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#create";  // untranslated
Blockly.Msg.TILEMAP_CREATE_LAYER = "create layer";  // untranslated
Blockly.Msg.TILEMAP_CREATE_LAYER_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#createLayer";  // untranslated
Blockly.Msg.TILEMAP_CREATE_LAYER_TOOLTIP = "Creates a new TilemapLayer object.";  // untranslated
Blockly.Msg.TILEMAP_CREATE_TOOLTIP = "Creates an empty map of the given dimensions and one blank layer.";  // untranslated
Blockly.Msg.TILEMAP_DESTROY_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#destroy";  // untranslated
Blockly.Msg.TILEMAP_DESTROY_TOOLTIP = "Removes all layer data from this tile map and nulls the game reference.";  // untranslated
Blockly.Msg.TILEMAP_FILL_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#fill";  // untranslated
Blockly.Msg.TILEMAP_FILL_INDEX = "with tiles from index";  // untranslated
Blockly.Msg.TILEMAP_FILL_TOOLTIP = "Fills the given area with the specified tile.";  // untranslated
Blockly.Msg.TILEMAP_FOR_EACH_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#forEach";  // untranslated
Blockly.Msg.TILEMAP_FOR_EACH_TOOLTIP = "For each tile in the given area defined by x/y and width/height run the given callback.";  // untranslated
Blockly.Msg.TILEMAP_GET_IMAGE_INDEX = "get index of tile";  // untranslated
Blockly.Msg.TILEMAP_GET_IMAGE_INDEX_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#getImageIndex";  // untranslated
Blockly.Msg.TILEMAP_GET_IMAGE_INDEX_TOOLTIP = "Gets the image index based on its name.";  // untranslated
Blockly.Msg.TILEMAP_GET_LAYER_INDEX = "get index of layer";  // untranslated
Blockly.Msg.TILEMAP_GET_LAYER_INDEX_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#getLayerIndex";  // untranslated
Blockly.Msg.TILEMAP_GET_LAYER_INDEX_TOOLTIP = "Gets the layer index based on its name.";  // untranslated
Blockly.Msg.TILEMAP_GET_TILE = "get tile in";  // untranslated
Blockly.Msg.TILEMAP_GET_TILESET_INDEX = "get index of tileset";  // untranslated
Blockly.Msg.TILEMAP_GET_TILESET_INDEX_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#getTilesetIndex";  // untranslated
Blockly.Msg.TILEMAP_GET_TILESET_INDEX_TOOLTIP = "Gets the tileset index based on its name.";  // untranslated
Blockly.Msg.TILEMAP_GET_TILE_ABOVE = "get tile";  // untranslated
Blockly.Msg.TILEMAP_GET_TILE_ABOVE_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#getTile%1";  // untranslated
Blockly.Msg.TILEMAP_GET_TILE_ABOVE_TOOLTIP = "Gets the tile around the tile coordinates given based on the given direction.";  // untranslated
Blockly.Msg.TILEMAP_GET_TILE_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#getTile";  // untranslated
Blockly.Msg.TILEMAP_GET_TILE_NULL = "do not return null?";  // untranslated
Blockly.Msg.TILEMAP_GET_TILE_TOOLTIP = "Gets a tile from the Tilemap Layer. The coordinates are given in tile values.";  // untranslated
Blockly.Msg.TILEMAP_HAS_TILE = "have a tile at";  // untranslated
Blockly.Msg.TILEMAP_HAS_TILE_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#hasTile";  // untranslated
Blockly.Msg.TILEMAP_HAS_TILE_TOOLTIP = "Checks if there is a tile at the given location.";  // untranslated
Blockly.Msg.TILEMAP_PASTE = "paste blocks from";  // untranslated
Blockly.Msg.TILEMAP_PASTE_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#paste";  // untranslated
Blockly.Msg.TILEMAP_PASTE_TOOLTIP = "Pastes a previously copied block of tile data into the given x/y coordinates. Data should have been prepared with Tilemap.copy.";  // untranslated
Blockly.Msg.TILEMAP_PUT_TILE_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#putTile";  // untranslated
Blockly.Msg.TILEMAP_PUT_TILE_TOOLTIP = "Puts a tile of the given index value at the coordinate specified.";  // untranslated
Blockly.Msg.TILEMAP_RANDOM = "randomise tiles in";  // untranslated
Blockly.Msg.TILEMAP_RANDOM_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#random";  // untranslated
Blockly.Msg.TILEMAP_RANDOM_TOOLTIP = "Randomises a set of tiles in a given area.";  // untranslated
Blockly.Msg.TILEMAP_REMOVE_ALL_LAYERS = "remove all layers from";  // untranslated
Blockly.Msg.TILEMAP_REMOVE_ALL_LAYERS_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#removeAllLayers";  // untranslated
Blockly.Msg.TILEMAP_REMOVE_ALL_LAYERS_TOOLTIP = "Removes all layers from this tile map.";  // untranslated
Blockly.Msg.TILEMAP_REMOVE_TILE = "remove tile from";  // untranslated
Blockly.Msg.TILEMAP_REMOVE_TILE_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#removeTile";  // untranslated
Blockly.Msg.TILEMAP_REMOVE_TILE_TOOLTIP = "Removes the tile located at the given coordinates and updates the collision data.";  // untranslated
Blockly.Msg.TILEMAP_REPLACE = "with tile from index";  // untranslated
Blockly.Msg.TILEMAP_REPLACE_DEST = "replace tile at index";  // untranslated
Blockly.Msg.TILEMAP_REPLACE_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#replace";  // untranslated
Blockly.Msg.TILEMAP_REPLACE_TOOLTIP = "Scans the given area for tiles with an index matching source and updates their index to match dest";  // untranslated
Blockly.Msg.TILEMAP_SEARCH_TILE_INDEX = "tile at index";  // untranslated
Blockly.Msg.TILEMAP_SEARCH_TILE_INDEX_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#searchTileIndex";  // untranslated
Blockly.Msg.TILEMAP_SEARCH_TILE_INDEX_TOOLTIP = "Searches the entire map layer for the first tile matching the given index, then returns that Phaser.Tile object.";  // untranslated
Blockly.Msg.TILEMAP_SET_COLLIISON_BY_EXCLUSION = "set collision for";  // untranslated
Blockly.Msg.TILEMAP_SET_COLLIISON_BY_EXCLUSION_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#setCollisionByExclusion";  // untranslated
Blockly.Msg.TILEMAP_SET_COLLIISON_BY_EXCLUSION_TILES = "except for tile array";  // untranslated
Blockly.Msg.TILEMAP_SET_COLLIISON_BY_EXCLUSION_TOOLTIP = "Sets collision on all tiles in the given layer, except for the IDs of those in the given array.";  // untranslated
Blockly.Msg.TILEMAP_SET_COLLISION = "set collision for tiles at index";  // untranslated
Blockly.Msg.TILEMAP_SET_COLLISION_BETWEEN = "set collision between tiles at index";  // untranslated
Blockly.Msg.TILEMAP_SET_COLLISION_BETWEEN_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#setCollisionBetween";  // untranslated
Blockly.Msg.TILEMAP_SET_COLLISION_BETWEEN_TOOLTIP = "Sets collision on a range of tiles where the tile IDs increment sequentially.";  // untranslated
Blockly.Msg.TILEMAP_SET_COLLISION_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#setCollision";  // untranslated
Blockly.Msg.TILEMAP_SET_COLLISION_TOOLTIP = "Sets collision on the given tile or tiles. You can pass in either a single numeric index or an array of indexes.";  // untranslated
Blockly.Msg.TILEMAP_SET_LAYER = "set layer for";  // untranslated
Blockly.Msg.TILEMAP_SET_LAYER_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#setLayer";  // untranslated
Blockly.Msg.TILEMAP_SET_LAYER_TOOLTIP = "Sets the current layer to the given index.";  // untranslated
Blockly.Msg.TILEMAP_SET_PREVENT_RECALCULATE = "prevent recalculate for tiles on";  // untranslated
Blockly.Msg.TILEMAP_SET_PREVENT_RECALCULATE_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#setPreventRecalculate";  // untranslated
Blockly.Msg.TILEMAP_SET_PREVENT_RECALCULATE_TOOLTIP = "Turn off/on the recalculation of faces for tile or collision updates.";  // untranslated
Blockly.Msg.TILEMAP_SET_TILE_INDEX_CALLBACK = "check collision for tiles at index";  // untranslated
Blockly.Msg.TILEMAP_SET_TILE_INDEX_CALLBACK_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#setTileIndexCallback";  // untranslated
Blockly.Msg.TILEMAP_SET_TILE_INDEX_CALLBACK_TOOLTIP = "Sets a global collision callback for the given tile index within the layer.";  // untranslated
Blockly.Msg.TILEMAP_SET_TILE_LOCATION_CALLBACK = "check collision for tiles on";  // untranslated
Blockly.Msg.TILEMAP_SET_TILE_LOCATION_CALLBACK_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#setTileLocationCallback";  // untranslated
Blockly.Msg.TILEMAP_SET_TILE_LOCATION_CALLBACK_TOOLTIP = "ets a global collision callback for the given map location within the layer.";  // untranslated
Blockly.Msg.TILEMAP_SET_TILE_SIZE = "set tile size for";  // untranslated
Blockly.Msg.TILEMAP_SET_TILE_SIZE_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#setTileSize";  // untranslated
Blockly.Msg.TILEMAP_SET_TILE_SIZE_TOOLTIP = "Sets the base tile size for the map.";  // untranslated
Blockly.Msg.TILEMAP_SHUFFLE = "shuffle tiles on";  // untranslated
Blockly.Msg.TILEMAP_SHUFFLE_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#shuffle";  // untranslated
Blockly.Msg.TILEMAP_SHUFFLE_TOOLTIP = "Shuffles a set of tiles in a given area. It will only randomise the tiles in that area, so if they're all the same nothing will appear to have changed!";  // untranslated
Blockly.Msg.TILEMAP_SWAP = "swap tiles at index";  // untranslated
Blockly.Msg.TILEMAP_SWAP_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Tilemap.html#swap";  // untranslated
Blockly.Msg.TILEMAP_SWAP_TOOLTIP = "Scans the given area for tiles with an index matching tileA and swaps them with tileB.";  // untranslated
Blockly.Msg.TILEMAP_SWAP_WITH = "with tiles at index";  // untranslated
Blockly.Msg.TILE_HEIGHT = "tile height";  // untranslated
Blockly.Msg.TILE_MARGIN = "tile margin";  // untranslated
Blockly.Msg.TILE_SPACING = "tile spacing";  // untranslated
Blockly.Msg.TILE_WIDTH = "tile width";  // untranslated
...
Blockly.Msg.TIMER_DURATION = "remaining duration of";  // untranslated
Blockly.Msg.TIMER_DURATION_HELP_URL = "http://dragondrop.digipen.edu/docs/Phaser.Timer.html#duration";  // untranslated
Blockly.Msg.TIMER_DURATION_TOOLTIP = "The duration in ms remaining until the next event will occur.";  // untranslated
...
Blockly.Msg.TYPE_CHARACTER = "character";  // untranslated
...
Blockly.Msg.UNTIL = "until";  // untranslated
...
Blockly.Msg.WHEN = "when";  // untranslated
