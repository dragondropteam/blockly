...
class Gen_compressed(threading.Thread):
    ...
    def run(self):
        self.gen_core()
        self.gen_blocks()
        self.gen_generator("javascript", "javascript")
        self.gen_generator("phaser", "javascript")
        self.gen_generator("python", "python")
        self.gen_generator("php", "php")
        self.gen_generator("dart", "dart")
        self.gen_generator("lua", "lua")
        self.gen_generator("c", "c")
        self.gen_generator("wink", "c")
        self.gen_generator("arduino", "c")
        self.gen_generator("ringo", "c")
    ...
    def gen_generator(self, language, folder):
