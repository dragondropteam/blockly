...
Blockly.C['arduino_string_create'] = function (block) {
  const input = Blockly.C.valueToCode(block, 'INPUT', Blockly.C.ORDER_ATOMIC) || 'String()';
...
Blockly.C['arduino_string_char_at'] = function (block) {
  ...
  const string = Blockly.C.valueToCode(block, 'STRING', Blockly.C.ORDER_ATOMIC) || 'String()';
  return [`${string}.charAt(${location})`, Blockly.C.ORDER_ATOMIC];
};

Blockly.C['arduino_string_compare_to'] = function (block) {
  const lhs = Blockly.C.valueToCode(block, 'LHS', Blockly.C.ORDER_ATOMIC) || 'String()';
  const rhs = Blockly.C.valueToCode(block, 'RHS', Blockly.C.ORDER_ATOMIC) || 'String()';
...
Blockly.C['arduino_string_equals_ignore_case'] = function (block) {
  const lhs = Blockly.C.valueToCode(block, 'LHS', Blockly.C.ORDER_ATOMIC) || 'String()';
  const rhs = Blockly.C.valueToCode(block, 'RHS', Blockly.C.ORDER_ATOMIC) || 'String()';
  return [`${lhs}.equalsIgnoreCase(${rhs})`, Blockly.C.ORDER_ATOMIC];
};
