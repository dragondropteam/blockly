 ...
 * @returns {} Stepper(steps, pin1, pin2, pin3, pin4)
 */
Blockly.C['stepper'] = function (block) {
  ...
  return [`Stepper(${steps},${pin1},${pin2},${pin3},${pin4})`, Blockly.C.ORDER_NONE];
};
 ...
 * @block
 * @param stepper {Stepper} the stepper motor to set the speed of
 ...
 * @method stepper_step
 * @block
 * @param stepper {Stepper} the stepper motor to start
